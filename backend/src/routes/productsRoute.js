...
import { getFeaturedProducts, getProducts, getProduct, getRelatedProducts } from '../controllers/productsController.js';
...
router.get('/:productId/related', asyncHandler(getRelatedProducts));
