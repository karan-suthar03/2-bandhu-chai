                    ...
                    {loading ? (
                        ...
                        <>
                            ...
                            <button 
                                ...
                                disabled={loading || orderSummary.itemCount === 0}
                            ...
                            <div className="bg-amber-50 border border-amber-200 rounded-lg p-4">
                                <div className="flex items-start space-x-3">
                                    ...
                                    <div>
                                        <h3 className="font-semibold text-amber-800 mb-1">Order Process</h3>
                                        <p className="text-sm text-amber-700">
                                            After confirming your order, we'll collect your details and contact you to arrange payment and delivery. 
